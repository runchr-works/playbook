...
export function hindsightPid(): number | undefined {
...
export async function startHindsightDaemon(env: NodeJS.ProcessEnv): Promise<number> {
...
export function stopHindsightDaemon(): boolean {
