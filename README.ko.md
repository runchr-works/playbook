...
- Node.js 22.5 이상
- Intentir가 로컬 Hindsight를 관리할 경우 [`uv`](https://docs.astral.sh/uv/)

onboarding 명령이 필요한 경우 CodeGraph를 설치하고 Hindsight를 설정합니다. Supabase는 Hindsight의
PostgreSQL 데이터베이스로 구성되며 Intentir가 직접 접근하지 않습니다.
